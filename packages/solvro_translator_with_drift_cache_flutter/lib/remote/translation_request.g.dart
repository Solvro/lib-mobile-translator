...
_TranslationRequest _$TranslationRequestFromJson(Map<String, dynamic> json) => _TranslationRequest(
...
Map<String, dynamic> _$TranslationRequestToJson(_TranslationRequest instance) => <String, dynamic>{

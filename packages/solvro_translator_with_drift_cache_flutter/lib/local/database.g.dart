...
class $$TranslationsTableFilterComposer
  ...
  ColumnFilters<int> get originalTextHash => $composableBuilder(
...
class $$TranslationsTableOrderingComposer
  ...
  ColumnOrderings<int> get originalTextHash => $composableBuilder(
    column: $table.originalTextHash,
...
class $$TranslationsTableAnnotationComposer
  ...
  GeneratedColumn<int> get originalTextHash => $composableBuilder(
    column: $table.originalTextHash,

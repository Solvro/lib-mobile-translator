...
/// Adds pattern-matching-related methods to [RemoteTranslationResponse].
extension RemoteTranslationResponsePatterns on RemoteTranslationResponse {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String originalText,  String translatedText,  String originalLanguageCode,  String translatedLanguageCode,  bool isApproved,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TranslationResponse() when $default != null:
return $default(_that.originalText,_that.translatedText,_that.originalLanguageCode,_that.translatedLanguageCode,_that.isApproved,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String originalText,  String translatedText,  String originalLanguageCode,  String translatedLanguageCode,  bool isApproved,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _TranslationResponse():
return $default(_that.originalText,_that.translatedText,_that.originalLanguageCode,_that.translatedLanguageCode,_that.isApproved,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String originalText,  String translatedText,  String originalLanguageCode,  String translatedLanguageCode,  bool isApproved,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _TranslationResponse() when $default != null:
return $default(_that.originalText,_that.translatedText,_that.originalLanguageCode,_that.translatedLanguageCode,_that.isApproved,_that.createdAt,_that.updatedAt);case _:
  return null;
